...
class ResetPasswordSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        try:
            ...
            flag = PasswordResetTokenGenerator.check_token(user,token)
            ...
            raise serializers.ValidationError("Decode Errors")
        #     flag = PasswordResetTokenGenerator.check_token(self,user=user,token=token)
        #     if not PasswordResetTokenGenerator.check_token(user, token):
        #         raise serializers.ValidationError("Token Invalid or Expired")
        # except User.DoesNotExist:
